...
?
        <div className={`rounded border border-gray-500 p-4 mt-2 group-hover:bg-gray-600 group-hover:transition-colors ${isActiveLesson ? 'border-yellow-300 group-hover:bg-transparent' :''} `}>
